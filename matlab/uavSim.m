...
plat = uavPlatform("UAV", scenario, "Trajectory", ...
    waypointTrajectory([0 0 -10; 100 0 -20; 100 100 -30], "TimeOfArrival", [0 12 20], "AutoBank", true,'ReferenceFrame', 'ENU'), 'ReferenceFrame', 'ENU');
...
while true
    % Advance scenario.
    isRunning = advance(scenario);which –all pathdef
